...
- `GET  /hdmi/histogram` — 64-bin grayscale histogram of latest HDMI frame; returns `{"bins":[64 ints], "clipped_low_pct": float, "clipped_high_pct": float, "ts": ISO8601}`. 503 if HDMI offline. Throttled to 1Hz on Pi.
