...
| `open` | Detector inference ~1600ms/frame before Part 5 — re-measure after deploy | `detector.py` | Part 5 (2026-05-07): `intra_op_num_threads` 2→3, `ORT_SEQUENTIAL`, PIL letterbox → cv2. Measure `detector_fps_actual` post-deploy; target ≥1.5fps. |
